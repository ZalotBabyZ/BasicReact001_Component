...
class App extends Component {
  ...
  render() {
    ...
    const theadStyle = { border: "1px solid #173f5f", backgroundColor: "#20639b", color: "white", height: "50px" };
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "20px" }}>
        ...
        <div style={{ display: "flex" }}>
          ...
          <button onClick={() => this.setState({ announcement: "" })} style={{ backgroundColor: "#f6d55c" }}>RESET</button>
        </div>
        <button onClick={() => this.setState({ isShow: !this.state.isShow })} style={{ position: "fixed", bottom: "50px", backgroundColor: "#20639b" }}> show </button>
        <table id="table" style={{ borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={{ ...theadStyle, width: "20vw" }}>Name</th>
              <th style={{ ...theadStyle, width: "45vw" }}>Email</th>
              <th style={{ ...theadStyle, width: "10vw" }}>Age</th>
              <th style={{ ...theadStyle, width: "20vw" }}>Announcement</th>
            </tr>
          </thead>
          <tbody>
            {this.state.isShow && CustomerList.filter(
